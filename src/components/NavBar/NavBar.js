    ...
    return (
        <nav className='flex justify-between items-center mb-24'>
            ...
            <div className=''>
                ...
                <div className={`text-xl font-semibold bg-white flex flex-col md:flex-row absolute md:static ease-in duration-300 ${open ? "h-full right-8 top-20" : "right-8 top-[-144px]"}`}>
